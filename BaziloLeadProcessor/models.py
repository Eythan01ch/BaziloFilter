...
class LeadEmailInfo(LeadStoreBaseModel):
	...
	status = models.CharField(max_length=2048, null=True, blank=True)
	sub_status = models.CharField(max_length=2048, null=True, blank=True)
	free_email = models.BooleanField(null=True, blank=True)
	did_you_mean = models.CharField(max_length=2048, null=True, blank=True)
	account = models.CharField(max_length=2048, null=True, blank=True)
	domain = models.CharField(max_length=2048, null=True, blank=True)
	domain_age_days = models.CharField(max_length=2048, null=True, blank=True)
	smtp_provider = models.CharField(max_length=2048, null=True, blank=True)
	mx_record = models.CharField(max_length=2048, null=True, blank=True)
	mx_found = models.CharField(max_length=2048, null=True, blank=True)
	firstname = models.CharField(max_length=2048, null=True, blank=True)
	lastname = models.CharField(max_length=2048, null=True, blank=True)
	gender = models.CharField(max_length=2048, null=True, blank=True)
	country = models.CharField(max_length=2048, null=True, blank=True)
	region = models.CharField(max_length=2048, null=True, blank=True)
	city = models.CharField(max_length=2048, null=True, blank=True)
	zipcode = models.CharField(max_length=2048, null=True, blank=True)
	processed_at = models.CharField(max_length=2048, null=True, blank=True)
...
class LeadPhoneInfo(LeadStoreBaseModel):
	Status = models.CharField(max_length=2048, null=True, blank=True)
	Region = models.CharField(max_length=2048, null=True, blank=True)
	CountryCode = models.CharField(max_length=2048, null=True, blank=True)
	Type = models.CharField(max_length=2048, null=True, blank=True)
	Country_Name = models.CharField(max_length=2048, null=True, blank=True)
...
class Lead(LeadStoreBaseModel):
	...
	email_status = models.CharField(max_length=2048, null=True, blank=True)
	phone_status = models.CharField(max_length=2048, null=True, blank=True)
	name_status = models.CharField(max_length=2048, null=True, blank=True)
...
class APIUtils(models.Model):
	...
	status = models.CharField(default='OK', max_length=2048, null=True, blank=True)
